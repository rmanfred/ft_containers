...
void test_char_v()
{
    std::cout << "Test-char for vector\n";

    std::vector<char> original(7, 'o');
    ft::vector<char> mine(7, 'o');

    std::cout << GREEN"**********Initialization************\n"RESET;

    std::cout << "initialization of original: \n";
    for (std::vector<char>::iterator or1 = original.begin(); or1 != original.end(); or1++)
    ...
    for (ft::vector<char>::iterator mn1 = mine.begin(); mn1 != mine.end(); mn1++)
        std::cout << "mine: " << *mn1 << "\n";
    std::cout << "size of mine: " << mine.size() << "\n";
    std::cout << "capacity of mine: " << mine.capacity() << "\n";

    std::cout << GREEN"**********Empty constructor**********\n"RESET;
    std::vector<char> orig_empty;
    ft::vector<char> mine_empty;
    ...
    std::vector<char> orig_copy(original);
    ft::vector<char> mine_copy(mine);

    std::cout << "copy of original: \n";
    for (std::vector<char>::iterator or2 = orig_copy.begin(); or2 != orig_copy.end(); or2++)
    ...
    for (ft::vector<char>::iterator mn2 = mine_copy.begin(); mn2 != mine_copy.end(); mn2++)
        std::cout << "mine: " << *mn2 << "\n";
    std::cout << "size of mine: " << mine_copy.size() << "\n";
    std::cout << "capacity of mine: " << mine_copy.capacity() << "\n";

    std::cout << GREEN"*************Assignation*************\n"RESET;
    std::vector<char> to_use(7, 'u');

    std::vector<char> orig_assign(to_use.begin(), to_use.end());
    std::cout << "Assignation of original: \n";
    for (std::vector<char>::iterator or3 = orig_assign.begin(); or3 != orig_assign.end(); or3++)
    ...
    ft::vector<char> to_use_mine(7, 'u');
    ft::vector<char> mine_assign(to_use_mine.begin(), to_use_mine.end());
    for (ft::vector<char>::iterator mn3 = mine_assign.begin(); mn3 != mine_assign.end(); mn3++)
        std::cout << "mine: " << *mn3 << "\n";
    ...
    for (std::vector<char>::iterator or4 = orig_empty.begin(); or4 != orig_empty.end(); or4++)
    ...
    for (ft::vector<char>::iterator mn4 = mine_empty.begin(); mn4 != mine_empty.end(); mn4++)
        std::cout << "mine: " << *mn4 << "\n";
    ...
    original.resize(23);
    for (std::vector<char>::iterator or5 = original.begin(); or5 != original.end(); or5++)
    ...
    mine.resize(23);
    for (ft::vector<char>::iterator mn5 = mine.begin(); mn5 != mine.end(); mn5++)
        std::cout << "mine: " << *mn5 << "\n";
    std::cout << "size of mine: " << mine.size() << "\n";
    std::cout << "capacity of mine: " << mine.capacity() << "\n";
    ...
    std::cout << "Insert one 'i' to original at pos 2: \n";
    std::vector<char>::iterator it = orig_assign.begin();
    it++;
    orig_assign.insert(it, 'i');
    std::cout << "Current orig_assign vector: \n";
    for (size_t j = 0; j < orig_assign.size(); j++)
        std::cout << orig_assign.at(j) << "| ";
    std::cout << std::endl;
    ...
    std::cout << "Insert one 'i' to mine at pos 2: \n";
    ft::vector<char>::iterator it_m = mine_assign.begin();
    it_m++;
    mine_assign.insert(it_m, 'i');
    std::cout << "Current mine_assign vector: \n";
    for (size_t j = 0; j < mine_assign.size(); j++)
        std::cout << mine_assign.at(j) << "| ";
    std::cout << std::endl;
    ...
    std::cout << "Insert 16 'n' to original at pos 3: \n";
    std::vector<char>::iterator it_2 = orig_assign.begin();
    it_2++;
    it_2++;
    orig_assign.insert(it_2, 16, 'n');
    std::cout << "Current orig_assign vector: \n";
    for (size_t j = 0; j < orig_assign.size(); j++)
        std::cout << orig_assign.at(j) << "| ";
    std::cout << std::endl;
    ...
    std::cout << "Insert  16 'n' to mine at pos 3: \n";
    ft::vector<char>::iterator it_m_2 = mine_assign.begin();
    it_m_2++;
    it_m_2++;
    mine_assign.insert(it_m_2, 16, 'n');
    std::cout << "Current mine_assign vector: \n";
    for (size_t j = 0; j < mine_assign.size(); j++)
        std::cout << mine_assign.at(j) << "| ";
    std::cout << std::endl;
    ...
    std::vector<char> fl_orign(9, 'e');
    ft::vector<char> fl_mine(9, 'e');
    fl_orign.push_back('p');
    fl_orign.push_back('i');
    fl_orign.push_back('r');
    fl_orign.push_back('o');
    ...
    std::cout << "Inserting.....\n";
    std::vector<char>::iterator fl_it = fl_orign.begin();
    ft::vector<char>::iterator fl_it_mine = fl_mine.begin();
    std::vector<char>::iterator fl_ite = fl_orign.end();
    ft::vector<char>::iterator fl_ite_mine = fl_mine.end();
    ...
    fl_orign.insert(fl_orign.begin(), 16, 'l');
    std::cout << "Original vector: \n";
    for (size_t j = 0; j < fl_orign.size(); j++)
        std::cout << fl_orign.at(j) << "| ";
    std::cout << std::endl;
    ...
    fl_mine.insert(fl_mine.begin(), 16, 'l');
    std::cout << "Mine vector: \n";
    for (size_t j = 0; j < fl_mine.size(); j++)
        std::cout << fl_mine.at(j) << "| ";
    std::cout << std::endl;
    ...
    std::vector<char>::iterator er = orig_assign.end();
    er--;
    ...
    ft::vector<char>::iterator er_m = mine_assign.end();
    er_m--;
    ...
    std::vector<char>::iterator er_2 = orig_assign.begin();
    std::vector<char>::iterator ere_2 = orig_assign.end();
    er_2++;
    er_2++;
    ere_2--;
    ere_2--;
    ...
    ft::vector<char>::iterator er_m_2 = mine_assign.begin();
    ft::vector<char>::iterator ere_m_2 = mine_assign.end();
    er_m_2++;
    er_m_2++;
    ere_m_2--;
    ere_m_2--;
    ...
    ft::vector<char> new_mine(5, 'k');
    new_mine.push_back('p');
    new_mine.push_back('g');
    new_mine.push_back('i');
    ...
    std::vector<char> butter(3, 'b');
    butter.push_back('a');
    butter.push_back('c');
    butter.push_back('d');
    butter.push_back('e');

    for (std::vector<char>::reverse_iterator butt = butter.rbegin(); butt != butter.rend(); butt++)
        std::cout << "print reverse original: " << *butt << "\n";
    
    ft::vector<char> m_butter(3, 'b');
    m_butter.push_back('a');
    m_butter.push_back('c');
    m_butter.push_back('d');
    m_butter.push_back('e');

    for (ft::vector<char>::reverse_iterator m_butt = m_butter.rbegin(); m_butt != m_butter.rend(); m_butt++)
        std::cout << "print reverse mine: " << *m_butt << "\n";

    std::cout << GREEN"*********Const_Rev_Iterator*********\n"RESET;
    std::vector<char> butter_2(3, 'b');
    butter_2.push_back('a');
    butter_2.push_back('c');
    butter_2.push_back('d');
    butter_2.push_back('e');

    for (std::vector<char>::const_reverse_iterator butt_2 = butter_2.rbegin(); butt_2 != butter_2.rend(); butt_2++)
        std::cout << "print const reverse original: " << *butt_2 << "\n";
    
    ft::vector<char> m_butter_2(3, 'b');
    m_butter_2.push_back('a');
    m_butter_2.push_back('c');
    m_butter_2.push_back('d');
    m_butter_2.push_back('e');

    for (ft::vector<char>::const_reverse_iterator m_butt_2 = m_butter_2.rbegin(); m_butt_2 != m_butter_2.rend(); m_butt_2++)
