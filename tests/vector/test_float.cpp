...
void test_float_v()
{
    std::cout << "Test-float for vector\n";

    std::vector<float> original(7, 1.98f);
    ft::vector<float> mine(7, 1.98f);

    std::cout << GREEN"**********Initialization************\n"RESET;

    std::cout << "initialization of original: \n";
    for (std::vector<float>::iterator or1 = original.begin(); or1 != original.end(); or1++)
    ...
    for (ft::vector<float>::iterator mn1 = mine.begin(); mn1 != mine.end(); mn1++)
        std::cout << "mine: " << *mn1 << "\n";
    std::cout << "size of mine: " << mine.size() << "\n";
    std::cout << "capacity of mine: " << mine.capacity() << "\n";

    std::cout << GREEN"**********Empty constructor**********\n"RESET;
    std::vector<float> orig_empty;
    ft::vector<float> mine_empty;
    ...
    std::vector<float> orig_copy(original);
    ft::vector<float> mine_copy(mine);

    std::cout << "copy of original: \n";
    for (std::vector<float>::iterator or2 = orig_copy.begin(); or2 != orig_copy.end(); or2++)
    ...
    for (ft::vector<float>::iterator mn2 = mine_copy.begin(); mn2 != mine_copy.end(); mn2++)
        std::cout << "mine: " << *mn2 << "\n";
    std::cout << "size of mine: " << mine_copy.size() << "\n";
    std::cout << "capacity of mine: " << mine_copy.capacity() << "\n";

    std::cout << GREEN"*************Assignation*************\n"RESET;
    std::vector<float> to_use(7, 11.32f);

    std::vector<float> orig_assign(to_use.begin(), to_use.end());
    std::cout << "Assignation of original: \n";
    for (std::vector<float>::iterator or3 = orig_assign.begin(); or3 != orig_assign.end(); or3++)
    ...
    ft::vector<float> to_use_mine(7, 11.32f);
    ft::vector<float> mine_assign(to_use_mine.begin(), to_use_mine.end());
    for (ft::vector<float>::iterator mn3 = mine_assign.begin(); mn3 != mine_assign.end(); mn3++)
        std::cout << "mine: " << *mn3 << "\n";
    ...
    for (std::vector<float>::iterator or4 = orig_empty.begin(); or4 != orig_empty.end(); or4++)
    ...
    for (ft::vector<float>::iterator mn4 = mine_empty.begin(); mn4 != mine_empty.end(); mn4++)
        std::cout << "mine: " << *mn4 << "\n";
    ...
    original.resize(23);
    for (std::vector<float>::iterator or5 = original.begin(); or5 != original.end(); or5++)
    ...
    mine.resize(23);
    for (ft::vector<float>::iterator mn5 = mine.begin(); mn5 != mine.end(); mn5++)
        std::cout << "mine: " << *mn5 << "\n";
    std::cout << "size of mine: " << mine.size() << "\n";
    std::cout << "capacity of mine: " << mine.capacity() << "\n";
    ...
    std::vector<float>::iterator it = orig_assign.begin();
    it++;
    orig_assign.insert(it, 4.56f);
    std::cout << "Current orig_assign vector: \n";
    for (size_t j = 0; j < orig_assign.size(); j++)
        std::cout << orig_assign.at(j) << "| ";
    std::cout << std::endl;
    ...
    ft::vector<float>::iterator it_m = mine_assign.begin();
    it_m++;
    mine_assign.insert(it_m, 4.56f);
    std::cout << "Current mine_assign vector: \n";
    for (size_t j = 0; j < mine_assign.size(); j++)
        std::cout << mine_assign.at(j) << "| ";
    std::cout << std::endl;
    ...
    std::vector<float>::iterator it_2 = orig_assign.begin();
    it_2++;
    it_2++;
    orig_assign.insert(it_2, 16, 5.76f);
    std::cout << "Current orig_assign vector: \n";
    for (size_t j = 0; j < orig_assign.size(); j++)
        std::cout << orig_assign.at(j) << "| ";
    std::cout << std::endl;
    ...
    ft::vector<float>::iterator it_m_2 = mine_assign.begin();
    it_m_2++;
    it_m_2++;
    mine_assign.insert(it_m_2, 16, 5.76f);
    std::cout << "Current mine_assign vector: \n";
    for (size_t j = 0; j < mine_assign.size(); j++)
        std::cout << mine_assign.at(j) << "| ";
    std::cout << std::endl;
    ...
    std::vector<float> fl_orign(9, 3.4);
    ft::vector<float> fl_mine(9, 3.4);
    ...
    std::cout << "Inserting.....\n";
    std::vector<float>::iterator fl_it = fl_orign.begin();
    ft::vector<float>::iterator fl_it_mine = fl_mine.begin();
    std::vector<float>::iterator fl_ite = fl_orign.end();
    ft::vector<float>::iterator fl_ite_mine = fl_mine.end();
    ...
    std::vector<float>::iterator er = orig_assign.end();
    er--;
    ...
    ft::vector<float>::iterator er_m = mine_assign.end();
    er_m--;
    ...
    std::vector<float>::iterator er_2 = orig_assign.begin();
    std::vector<float>::iterator ere_2 = orig_assign.end();
    er_2++;
    er_2++;
    ere_2--;
    ere_2--;
    ...
    ft::vector<float>::iterator er_m_2 = mine_assign.begin();
    ft::vector<float>::iterator ere_m_2 = mine_assign.end();
    er_m_2++;
    er_m_2++;
    ere_m_2--;
    ere_m_2--;
    ...
    std::vector<float> new_or(5, 6.123f);
    new_or.push_back(7.456f);
    new_or.push_back(8.789f);
    new_or.push_back(9.123f);
    std::cout << "New vector:\n";
    ...
    ft::vector<float> new_mine(5, 6.123f);
    new_mine.push_back(7.456f);
    new_mine.push_back(8.789f);
    new_mine.push_back(9.123f);
